...
class ClientController extends FormController
{
    ...
    public function indexAction ($page = 1)
    {
        ...
        $model = $this->factory->getModel('migration.client');

        // @todo make permissions work
        // set some permissions
        // $permissions = $this->factory->getSecurity()->isGranted(array(
        //     'mauticMigration:clients:viewown',
        //     'mauticMigration:clients:viewother',
        //     'mauticMigration:clients:create',
        //     'mauticMigration:clients:editown',
        //     'mauticMigration:clients:editother',
        //     'mauticMigration:clients:deleteown',
        //     'mauticMigration:clients:deleteother'
        // ), "RETURN_ARRAY");


        // if (!$permissions['mauticMigration:clients:viewown'] && !$permissions['mauticMigration:clients:viewother']) {
