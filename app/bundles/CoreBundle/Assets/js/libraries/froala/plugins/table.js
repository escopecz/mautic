...
(function (factory) {
    ...
    function _insertTableHtml () {
      ...
      for (var i = 1; i <= editor.opts.tableInsertMaxSize; i++) {
        for (var j = 1; j <= editor.opts.tableInsertMaxSize; j++) {
          ...
          rows_columns += '<span class="fr-command ' + cls + '" tabIndex="-1" data-cmd="tableInsert" data-row="' + i + '" data-col="' + j + '" data-param1="' + i + '" data-param2="' + j + '" style="display: ' + display + ';"><span></span></span>';
        }
    ...
    function _colorsHTML () {
      ...
      for (var i = 0; i < editor.opts.tableColors.length; i++) {
        ...
        if (editor.opts.tableColors[i] != 'REMOVE') {
          colors_html += '<span class="fr-command" style="background: ' + editor.opts.tableColors[i] + ';" tabIndex="-1" data-cmd="tableCellBackgroundColor" data-param1="' + editor.opts.tableColors[i] + '"></span>';
        }

        else {
          colors_html += '<span class="fr-command" data-cmd="tableCellBackgroundColor" tabIndex="-1" data-param1="REMOVE" title="' + editor.language.translate('Clear Formatting') + '"><i class="fa fa-eraser"></i></span>';
        }
      }
      ...
      if (!editor.helpers.isMobile()) {
        ...
        editor.events.on('keydown', function (e) {
          ...
          if (selected_cells.length > 0) {
            ...
            if (selected_cells.length > 1 && !editor.keys.ctrlKey(e) && e.which != $.FE.KEYCODE.F10) {
              e.preventDefault();
              selected_cells = [];
              return false;
            }
    ...
    html: function () {
      ...
      for (var val in options) {
        if (options.hasOwnProperty(val)) {
          c += '<li><a class="fr-command" tabIndex="-1" data-cmd="tableRows" data-param1="' + val + '" title="' + this.language.translate(options[val]) + '">' + this.language.translate(options[val]) + '</a></li>';
        }
      }
      c += '</ul>';
  ...
  $.FE.RegisterCommand('tableColumns', {
    ...
    html: function () {
      ...
      for (var val in options) {
        if (options.hasOwnProperty(val)) {
          c += '<li><a class="fr-command" tabIndex="-1" data-cmd="tableColumns" data-param1="' + val + '" title="' + this.language.translate(options[val]) + '">' + this.language.translate(options[val]) + '</a></li>';
        }
      }
      c += '</ul>';
  ...
  $.FE.RegisterCommand('tableCells', {
    ...
    html: function () {
      ...
      for (var val in options) {
        if (options.hasOwnProperty(val)) {
          c += '<li><a class="fr-command" tabIndex="-1" data-cmd="tableCells" data-param1="' + val + '" title="' + this.language.translate(options[val]) + '">' + this.language.translate(options[val]) + '</a></li>';
        }
      }
      c += '</ul>';
  ...
  $.FE.RegisterCommand('tableStyle', {
    ...
    html: function () {
      ...
      for (var val in options) {
        if (options.hasOwnProperty(val)) {
          c += '<li><a class="fr-command" tabIndex="-1" data-cmd="tableStyle" data-param1="' + val + '" title="' + this.language.translate(options[val]) + '">' + this.language.translate(options[val]) + '</a></li>';
        }
      }
      c += '</ul>';
  ...
  $.FE.RegisterCommand('tableCellVerticalAlign', {
    ...
    html: function () {
      ...
      for (var val in options) {
        if (options.hasOwnProperty(val)) {
          c += '<li><a class="fr-command" tabIndex="-1" data-cmd="tableCellVerticalAlign" data-param1="' + val.toLowerCase() + '" title="' + this.language.translate(options[val]) + '">' + this.language.translate(val) + '</a></li>';
        }
      }
      c += '</ul>';
  ...
  $.FE.RegisterCommand('tableCellHorizontalAlign', {
    ...
    html: function () {
      ...
      for (var val in options) {
        if (options.hasOwnProperty(val)) {
          c += '<li><a class="fr-command fr-title" tabIndex="-1" data-cmd="tableCellHorizontalAlign" data-param1="' + val + '" title="' + this.language.translate(options[val]) + '">' + this.icon.create('align-' + val) + '</a></li>';
        }
      }
      c += '</ul>';
  ...
  $.FE.RegisterCommand('tableCellStyle', {
    ...
    html: function () {
      ...
      for (var val in options) {
        if (options.hasOwnProperty(val)) {
          c += '<li><a class="fr-command" tabIndex="-1" data-cmd="tableCellStyle" data-param1="' + val + '" title="' + this.language.translate(options[val]) + '">' + this.language.translate(options[val]) + '</a></li>';
        }
      }
      c += '</ul>';
